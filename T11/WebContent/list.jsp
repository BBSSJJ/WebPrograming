...
<input type="button" onClick="delete_multi()" value="선택 삭제">
...
<%
    while(rs.next()) {
%><tr>
<td><input type="checkbox" name="selected_idx" value=""></td>
<td><!-- 6. idx 값을 출력한다.   --><%=rs.getInt("idx") %></td>
<td><%=rs.getString(2)%></td>
<td><!-- 7.name을 출력한다. --><%=rs.getString("name") %></td>
